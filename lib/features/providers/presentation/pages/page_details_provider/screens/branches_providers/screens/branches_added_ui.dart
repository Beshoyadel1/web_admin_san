...
import 'package:web_admin_san/features/store_page/presentation/pages/store_widgets/custom_add_button.dart';
...
class BranchesAddedUi extends StatelessWidget {
  ...
  const BranchesAddedUi({super.key, required this.state,required this.providerId});
...
Widget _deleteButton(BuildContext context, List branches, branch,int providerId,
    {bool isSmall = false}) {
