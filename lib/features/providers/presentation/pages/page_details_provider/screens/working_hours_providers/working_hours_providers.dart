...
class WorkingHoursProviders extends StatefulWidget {
  ...
  const WorkingHoursProviders({super.key,required this.providerID});

  @override
  State<WorkingHoursProviders> createState() => _WorkingHoursProvidersState();
}

class _WorkingHoursProvidersState extends State<WorkingHoursProviders> {
