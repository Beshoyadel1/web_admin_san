...
import '../../../../../../../../features/order_status_design/presentation/pages/order_details_waiting_emp/screens/list_data_order_details_waiting_emp.dart';
import '../../../../../../../../features/order_status_design/presentation/pages/order_details_waiting_emp/screens/part_left_screen/data_part_left_screen_order_details_waiting_emp.dart';
              ...
              if ((!isMobile))
                const Expanded(
                  ...
                  child: Padding(
                    ...
                    child: SingleChildScrollView(
                      child: DataPartLeftScreenOrderDetailsWaitingEmp()
                    ),
                  ),
                ),
            ],
