...
class OrderDetailsRejectByProviderOrderEmp extends StatelessWidget {
  ...
  const OrderDetailsRejectByProviderOrderEmp({super.key,required this.order});
               ...
               Expanded(
                ...
                child: Padding(
                  ...
                  child: SingleChildScrollView(
                    child: ListDataOrderDetailsRejectByProviderOrderEmp(
                        order:order
                    ),
                  ),
                ),
              ...
              if ((!isMobile))
                const Expanded(
                  ...
                  child: Padding(
                    ...
                    child: SingleChildScrollView(
                      child: DataPartLeftScreenOrderDetailsRejectByProviderOrderEmp()
                    ),
                  ),
                ),
            ],
