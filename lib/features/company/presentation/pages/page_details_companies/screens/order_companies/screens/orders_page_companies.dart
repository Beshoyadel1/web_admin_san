...
class OrdersPageCompanies extends StatelessWidget {
  final int companyId;
  const OrdersPageCompanies({super.key, required this.cubit,required this.companyId});
          ...
          children: [
            ...
            SizedBox(
              ...
              child: MultiBlocProvider(
                ...
                child: FiltersTabsCompaniesWidget(
