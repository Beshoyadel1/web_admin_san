...
Future<CouponWithProviderModel> getCouponDetailsFunction({
  required GetCouponDetailsRequest request,
}) async {
  try {
    final response = await Network.postDataWithBodyAndParams(
      {},
      request.toJson(),
      ApiLink.getCouponDetails,
    );
    ...
    if (!success) {
      throw Exception(
        responseData['message'] ?? 'Failed to get coupon details',
      );
    }
