...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'ar': {
      ...
      AppLanguageKeys.invoiceItem: 'عنصر الفاتورة',
      AppLanguageKeys.carServicesStatistics: 'إحصائيات خدمات السيارة',
      AppLanguageKeys.totalInvoices: 'إجمالي الفواتير',
      AppLanguageKeys.fuelConsumptionRate: 'معدل استهلاك الوقود',
      AppLanguageKeys.fuel: 'الوقود',
      AppLanguageKeys.consumptionSaving: 'توفير الاستهلاك',
      AppLanguageKeys.sellDate: 'تاريخ البيع',
      AppLanguageKeys.kilometers: 'كيلومترات',
      AppLanguageKeys.selectDurationType: 'اختر نوع المدة',
      AppLanguageKeys.day: 'يوم',
      AppLanguageKeys.month: 'شهر',
      AppLanguageKeys.year: 'سنة',
      AppLanguageKeys.warranty: 'الضمان',
      AppLanguageKeys.durationType: 'نوع المدة',
      AppLanguageKeys.durationValue: 'قيمة المدة',
      AppLanguageKeys.orders: 'الطلبات',
      AppLanguageKeys.providers: 'مزودي الخدمة',
      AppLanguageKeys.finances: 'المالية',
      AppLanguageKeys.approvals: 'الموافقات',
      AppLanguageKeys.ranks: 'التصنيفات',
      AppLanguageKeys.support: 'الدعم',
      AppLanguageKeys.banners: 'الإعلانات',
      AppLanguageKeys.coupons: 'الكوبونات',
      AppLanguageKeys.harage: 'حراج السيارات',
      AppLanguageKeys.insurance: 'التأمين',
      AppLanguageKeys.noPermissionsAssigned: 'لم يتم تعيين صلاحيات',
      AppLanguageKeys.adminDetails: 'تفاصيل المسؤول',
      AppLanguageKeys.admins: 'المسؤولين',
      AppLanguageKeys.admin: 'المسؤول',
      ...
      AppLanguageKeys.condition: 'الحالة',
      ...
      AppLanguageKeys.discountType: 'نوع الخصم',
      AppLanguageKeys.discountValue: 'قيمة الخصم',
      AppLanguageKeys.isActive: 'مفعل',
      AppLanguageKeys.maxDiscountValue: 'الحد الأقصى للخصم',
      AppLanguageKeys.minValueToApply: 'الحد الأدنى للتطبيق',
      ...
      AppLanguageKeys.packageDisc: 'وصف الباقة',
      AppLanguageKeys.packageLatinDisc: 'وصف الباقة بالإنجليزية',
      ...
      AppLanguageKeys.paymentMethods: 'طرق الدفعات',
      AppLanguageKeys.paymentDuration: 'مدة الدفعات',
      AppLanguageKeys.insuranceMethods: 'طرق التأمين',
      AppLanguageKeys.modelFrom: 'موديل من',
      AppLanguageKeys.insuranceDirection: 'توجه التأمين',
      AppLanguageKeys.insuranceCategories: 'أقسام التأمين',
      AppLanguageKeys.deductiblePercentage: 'نسبة التحمل',
      AppLanguageKeys.startsFrom: 'يبدأ من',
      AppLanguageKeys.installments: 'الدفعات',
      AppLanguageKeys.modelTo: 'موديل إلى',
      AppLanguageKeys.instantApproval: 'موافقة فورية',
      AppLanguageKeys.personalAccidents: 'حوادث شخصية',
      AppLanguageKeys.noClaimDiscount: 'خصم عدم المطالبة',
      AppLanguageKeys.maximumLimit: 'الحد الأقصى',
      AppLanguageKeys.totalInsuranceInstallments: 'إجمالي دفعات التأمين',
      AppLanguageKeys.transferableBalance: 'الرصيد القابل للتحويل',
      AppLanguageKeys.overdueInstallments: 'الدفعات المتأخرة',
      AppLanguageKeys.deactivate: 'إلغاء التفعيل',
...
''',
    ...
    'en': {
      ...
      AppLanguageKeys.carServicesStatistics: 'Car Services Statistics',
      AppLanguageKeys.totalInvoices: 'Total Invoices',
      AppLanguageKeys.fuelConsumptionRate: 'Fuel Consumption Rate',
      AppLanguageKeys.fuel: 'Fuel',
      AppLanguageKeys.consumptionSaving: 'Consumption Saving',
      AppLanguageKeys.sellDate: 'Sell Date',
      AppLanguageKeys.kilometers: 'Kilometers',
      AppLanguageKeys.selectDurationType: 'Select Duration Type',
      AppLanguageKeys.day: 'Day',
      AppLanguageKeys.month: 'Month',
      AppLanguageKeys.year: 'Year',
      AppLanguageKeys.warranty: 'Warranty',
      AppLanguageKeys.durationType: 'Duration Type',
      AppLanguageKeys.durationValue: 'Duration Value',
      AppLanguageKeys.orders: 'Orders',
      AppLanguageKeys.providers: 'Service Providers',
      AppLanguageKeys.finances: 'Finances',
      AppLanguageKeys.approvals: 'Approvals',
      AppLanguageKeys.ranks: 'Ranks',
      AppLanguageKeys.support: 'Support',
      AppLanguageKeys.banners: 'Banners',
      AppLanguageKeys.coupons: 'Coupons',
      AppLanguageKeys.harage: 'Car Haraj',
      AppLanguageKeys.insurance: 'Insurance',
      AppLanguageKeys.noPermissionsAssigned: 'No permissions assigned',
      AppLanguageKeys.adminDetails: 'Admin Details',
      AppLanguageKeys.admins: 'Admins',
      AppLanguageKeys.admin: 'Admin',
      ...
      AppLanguageKeys.condition: 'Condition',
      ...
      AppLanguageKeys.discountType: 'Discount Type',
      AppLanguageKeys.discountValue: 'Discount Value',
      AppLanguageKeys.isActive: 'Is Active',
      AppLanguageKeys.maxDiscountValue: 'Maximum Discount Value',
      AppLanguageKeys.minValueToApply: 'Minimum Value to Apply',
      AppLanguageKeys.couponStartDate: 'Coupon Start Date',
      AppLanguageKeys.couponEndDate: 'Coupon End Date',
      AppLanguageKeys.usersUseCount: 'Users Use Count',
      AppLanguageKeys.oneUserUseCount: 'One User Use Count',
      AppLanguageKeys.packageNotFound: 'Package not found',
      AppLanguageKeys.packageLatinName: 'Package Latin Name',
      AppLanguageKeys.monthPrice: 'Monthly Price',
      AppLanguageKeys.packageDisc: 'Package Description',
      AppLanguageKeys.packageLatinDisc: 'Package Latin Description',
      ...
      AppLanguageKeys.paymentMethods: 'Payment Methods',
      AppLanguageKeys.paymentDuration: 'Payment Duration',
      AppLanguageKeys.insuranceMethods: 'Insurance Methods',
      AppLanguageKeys.modelFrom: 'Model From',
      AppLanguageKeys.insuranceDirection: 'Insurance Direction',
      AppLanguageKeys.insuranceCategories: 'Insurance Categories',
      AppLanguageKeys.deductiblePercentage: 'Deductible Percentage',
      AppLanguageKeys.startsFrom: 'Starts From',
      AppLanguageKeys.installments: 'Installments',
      AppLanguageKeys.modelTo: 'Model To',
      AppLanguageKeys.instantApproval: 'Instant Approval',
      AppLanguageKeys.personalAccidents: 'Personal Accidents',
      AppLanguageKeys.noClaimDiscount: 'No Claim Discount',
      AppLanguageKeys.maximumLimit: 'Maximum Limit',
      AppLanguageKeys.totalInsuranceInstallments: 'Total Insurance Installments',
      AppLanguageKeys.transferableBalance: 'Transferable Balance',
      AppLanguageKeys.overdueInstallments: 'Overdue Installments',
      AppLanguageKeys.deactivate: 'Deactivate',
